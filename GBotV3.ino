...
D2  - Control Pin (Half Duplex Serial Communication: Transmit -> Low, Receive -> High
D12 - Push Button 1 
D13 - Push Button 2

For further details, please refer to http://hubonit.com/ideas/?p=126
...
*/
  ...
  #if defined (ARDUINO_AVR_YUN)
  digitalWrite(TxRx_Pin, LOW); //Transmit 
  Serial1.write(x, n);
  Serial.println(s);
  digitalWrite(TxRx_Pin, HIGH); //Receive
